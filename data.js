const dex = [
    {id: 1, name: 'Pete' , pokemon: ['Larvitar', 'Pupitar', 'Tyranitar'],type: 'Ground', audio: 'larvitar.mp3', image: ['larvitar.png','pupitar.png','tyranitar.png'], description:[
    ...
    {id: 2, name: 'Ariel', pokemon: ['Pichu', 'Pikachu', 'Raichu'], type: 'Electric', audio: 'pikachu.mp3', image: ['pichu.png', 'pikachu.png', 'raichu.png'], 
    description:[
    ...
    {id: 3, name: 'Rikke', pokemon: ['Starly', 'Staravia', 'Staraptor'], type: 'Flying', audio: 'staravia.mp3', image: ['starly.png', 'staravia.png', 'staraptor.png'], description: [
    ...
    {id: 4, name: 'Keenen', pokemon: ['Bulbasaur', 'Ivysaur', 'Venusaur'], type: 'Grass', audio: 'bulbasaur.mp3', image: ['bulbasaur.png', 'ivysaur.png', 'venusaur.png'], description: [
    ...
    {id: 5, name: 'Kim', pokemon: ['Charmander', 'Charmeleon', 'Charizard'], type: 'Fire' , audio: 'charmander.mp3', image: ['charmander.png', 'charmeleon.png', 'charizard.png'], description: [
    ...
    {id: 6, name: 'Jonty', pokemon: ['Chikorita', 'Bayleef', 'Meganium'], type: 'Grass' , audio: 'meganium.mp3', image: ['chikorita.png', 'bayleef.png', 'meganium.png'], description: [
    ...
    {id: 7, name: 'Isaac', pokemon: ['Rowlet', 'Datrix', 'Decidueye'], type: 'Grass' , audio: 'rowlet.mp3', image: ['rowlet.png','dartrix.png','decidueye.png'], description: [
    ...
    {id: 8, name: 'Ariana', pokemon: ['Pidgey', 'Pidgeotto', 'Pidgeot'], type: 'Flying' , audio: 'pidgey.mp3', image: ['pidgey.png', 'pidgeotto.png', 'pidgeot.png'], description: [
    ...
    {id: 9, name: 'Jake', pokemon: ['Treecko', 'Grovyle', 'Sceptile'], type: 'Grass' , audio: 'treecko.mp3', image: ['treecko.png', 'grovyle.png', 'sceptile.png'], description: [
    ...
    {id: 10, name: 'Johnny', pokemon: ['Rookidee', 'Corvisquire', 'Corviknight'], type: 'Flying' , audio: 'corvisquire.mp3', image: ['rookidee.png', 'corvisquire.png', 'corviknight.png'], description: [
    ...
    {id: 11, name: 'Zac', pokemon: ['Totodile', 'Croconaw', 'Feraligatr'], type: 'Water' , audio: 'totodile.mp3', image: ['totodile.png', 'croconaw.png', 'feraligatr.png'], description: [
    ...
    {id: 12, name: 'Louis', pokemon: ['Sandile', 'Krokorok', 'Krookidile'], type: 'Ground' , audio: 'sandile.mp3', image: ['sandile.png', 'krokorok.png', 'krookodile.png'], description: [
    ...
    {id: 13, name: 'Don', pokemon: ['Torchic', 'Combusken', 'Blaziken'], type: 'Fire' , audio: 'torchic.mp3', image: ['torchic.png', 'combusken.png', 'blaziken.png'], description: [
    ...
    {id: 14, name: 'Laché', pokemon: ['Pidove', 'Tranquill', 'Unfezant'], type: 'Flying' , audio: 'pidove.mp3', image: ['pidove.png', 'tranquill.png', 'unfezant.png'], description: [
    ...
    {id: 15, name: 'Emily', pokemon: ['Rhyhorn', 'Rhydon', 'Rhyperior'], type: 'Ground' , audio: 'rhyhorn.mp3', image: ['rhyhorn.png', 'rhydon.png', 'rhyperior.png'], description: [
    ...
    {id: 16, name: 'Lane', pokemon: ['Mudkip', 'Marshtomp', 'Swampert'], type: 'Water' , audio: 'mudkip.mp3', image: ['mudkip.png', 'marshtomp.png', 'swampert.png'], description: [
    ...
    {id: 17, name: 'Dougal', pokemon: ['Cyndaquil', 'Quilava', 'Typhlosion'], type: 'Fire' , audio: 'cyndaquil.mp3', image: ['cyndaquil.png', 'quilava.png', 'typhlosion.png'], description: [
    ...
    {id: 18, name: 'Carolyn', pokemon: ['Squirtle', 'Wartortle', 'Blastoise'], type: 'Water' , audio: 'squirtle.mp3', image: ['squirtle.png', 'wartortle.png', 'blastoise.png'], description: [
    ...
    {id: 19, name: 'Phoenix', pokemon: ['Elekid', 'Electabuzz', 'Electivire'], type: 'Electric' , audio: 'electabuzz.mp3', image: ['elekid.png', 'electabuzz.png', 'electivire.png'], description: [
